...
// MyWebDoc.cpp : CMyWebDoc 클래스의 구현
//
...
// 축소판 그림을 지원합니다.
void CMyWebDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMyWebDoc::InitializeSearchContent()
{
...
void CMyWebDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
