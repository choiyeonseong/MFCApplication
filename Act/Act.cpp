...
// Act.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CActApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CActApp::OnAppAbout)
...
CActApp::CActApp()
{
	...
	SetAppID(_T("Act.AppID.NoVersion"));
...
// {D65D015A-BE75-4540-AEE3-7D717B89EEF9}
static const CLSID clsid =
{ 0xD65D015A, 0xBE75, 0x4540, { 0xAE, 0xE3, 0x7D, 0x71, 0x7B, 0x89, 0xEE, 0xF9 } };
...
BOOL CActApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CActDoc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CActView));
	if (!pDocTemplate)
		return FALSE;
