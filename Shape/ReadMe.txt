================================================================================
    MFC 라이브러리 : Shape 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 Shape 응용 프로그램을 만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램을 작성하기 위한 기본 구조를 제공합니다.
...
Shape.h
    ...
    여기에는 resource.h를 비롯한 다른 프로젝트별 헤더가 포함되어 있으며 CShapeApp 응용 프로그램 클래스가 선언되어 있습니다.

Shape.cpp
    이는 응용 프로그램 클래스 CShapeApp가 포함된 기본 응용 프로그램 소스 파일입니다.
...
res\Shape.ico
    아이콘 파일이며, 응용 프로그램의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 Shape.rc에 의해 포함됩니다.
...
ShapeDoc.h, ShapeDoc.cpp - 문서
    이 파일에는 CShapeDoc 클래스가 포함됩니다. 이 파일을 편집하여 특수 문서 데이터를 추가하고 CShapeDoc::Serialize를 통해 파일 저장 및 로드를 구현합니다.

ShapeView.h, ShapeView.cpp - 문서 뷰
    이 파일에는 CShapeView 클래스가 포함됩니다.
    CShapeView 개체는 CShapeDoc 개체를 보는 데 사용됩니다.
