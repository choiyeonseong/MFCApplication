...
// 축소판 그림을 지원합니다.
void CIPCDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CIPCDoc::InitializeSearchContent()
{
...
void CIPCDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
